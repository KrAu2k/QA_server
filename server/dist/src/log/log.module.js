...
const log_helper_1 = require("./utils/log-helper");
...
exports.LogModule = LogModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [log_service_1.LogService, log_helper_1.LogHelper],
        exports: [log_service_1.LogService, log_helper_1.LogHelper],
    })
], LogModule);
